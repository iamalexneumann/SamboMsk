...
$MESS["T_IBLOCK_DESC_NEWS_SHOW_CTA_FORM"] = "Показывать форму призыва к действию в списке?";
$MESS["T_IBLOCK_DESC_NEWS_CTA_FORM_POSITION"] = "После какого элемента списка показывать форму призыва к действию";
