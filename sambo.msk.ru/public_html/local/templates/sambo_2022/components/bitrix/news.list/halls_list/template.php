            ...
            <article class="hall" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                ...
                <div class="hall__wrapper">
                    <header class="hall__header">
                        ...
                        <div class="set-open">
                            <div class="set-open__icons set-open__icons_<?php if ($arItem['DISPLAY_PROPERTIES']['ATT_SET_OPEN']['VALUE_XML_ID'] === 'Y'): ?>open<?php else: ?>closed<?php endif; ?>">
                    ...
                    <a href="<?= $arItem['DETAIL_PAGE_URL']; ?>" class="btn btn-primary hall__btn" rel="nofollow">
                        <?= Loc::getMessage('HALLS_LIST_MORE_BTN_TEXT'); ?> <i class="fa-solid fa-angle-right hall__btn-icon"></i>
                    </a>
                </div>
            </article>
        </div>
