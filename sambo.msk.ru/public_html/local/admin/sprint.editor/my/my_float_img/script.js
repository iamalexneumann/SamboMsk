sprint_editor.registerBlock('my_float_img', function ($, $el, data) {
    ...
    this.collectData = function () {
        ...
        data.css_class = $el.find('.sp-item-select').val();
        return data;
    };
    ...
    this.afterRender = function () {
        ...
        $btninput.fileupload({
            dropZone: $el,
            url: sprint_editor.getBlockWebPath('my_float_img') + '/upload.php',
            dataType: 'json',
        ...
        $el.find('.sp-download-url').bindWithDelay('input', function () {
            ...
            $.ajax({
                url: sprint_editor.getBlockWebPath('my_float_img') + '/download.php',
                type: 'post',
                data: {
                    url: urlvalue
                },
